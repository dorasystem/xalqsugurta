...
<div class="container">
    ...
    <div class="flex items-center gap-2 mb-5">
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm text-gray-400">{{ __('messages.vehicle_info') ?? __('insurance.kasko.vehicle_info') }}</span>
        </div>
        <div class="flex-1" style="height:1px;background:#e5e7eb;"></div>
        <div class="flex items-center gap-2">
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <form action="{{ route('kasko.storeApplicant', ['locale' => getCurrentLocale()]) }}" method="POST">
                    @csrf
                    <div class="p-5">
                        <div class="row g-3">
                            <div class="col-sm-4">
