    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-4">
                ...
                <div class="row g-2">
                    @foreach([
                        [__('insurance.kasko.gov_number'),    $vehicle['regnumber']],
                        [__('insurance.kasko.brand_model'),   $vehicle['brand'] . ' ' . $vehicle['model']],
                        [__('insurance.kasko.year'),          $vehicle['year']],
                        [__('insurance.kasko.tp_seria') . ' / ' . __('insurance.kasko.tp_number'), $vehicle['tp_seria'] . ' ' . $vehicle['tp_number']],
                        [__('insurance.kasko.body_number'),   $vehicle['body_number']],
                        [__('insurance.kasko.engine_number'), $vehicle['engine_number']],
                    ] as [$lbl, $val])
                    <div class="col-sm-6">
                        <p class="text-xs text-gray-400 mb-0">{{ $lbl }}</p>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('kasko.getVehicle', ['locale' => getCurrentLocale()]) }}"
                ...
                <form action="{{ route('kasko.storeApplication', ['locale' => getCurrentLocale()]) }}" method="POST">
                    @csrf
