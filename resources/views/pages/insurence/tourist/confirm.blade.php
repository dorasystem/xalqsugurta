...
<div class="container">
    ...
    <div class="flex items-center gap-2 mb-5">
        @foreach([1 => __('messages.applicant'), 2 => __('messages.insured_persons'), 3 => __('messages.insurance_summary'), 4 => __('messages.confirm_details')] as $num => $label)
            <div class="flex items-center gap-2">
                ...
                @else
                    <div class="w-7 h-7 rounded-full bg-blue-600 flex items-center justify-center text-white" style="font-size:11px;font-weight:700;">4</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('tourist.getCalculator', ['locale' => getCurrentLocale()]) }}"
                ...
                <form action="{{ route('tourist.storeApplication', ['locale' => getCurrentLocale()]) }}" method="POST">
                    @csrf
                    <button type="submit"
