        <footer class="footer">
            <div class="footer__wrapper">
                ...
                <div class="footer-bottom">
                    <span class="footer-copyright">2023 © XALQ SUG`URTA</span>
                    <a class="copyright-logo" href="https://alex-software.ru/" target="_blank" rel="nofollow noopener"
                        aria-label="Разработано Alex software">
